...
double 	Sres,SEslope,SEintercept,slopehigh,slopelow,intercepthigh,interceptlow,corrlow,corrhigh;
HWND 		hwndlocal;
struct 	ASCAL  axcal;
/*************** teken plaatje ***************/
...
void teken_graph(HWND hwnd,HDC hdc,struct ASCAL *ascal,int rowx,int rowy)
 ...
 double minx,miny;
 double lowy,highy;
 double lowx,highx,inc;
 double vx,vy,asx,asy;
 double offpixx,offpixy;
 double lx,ly,mx,my,ml,mh,a,b,tus;
 float  xpos,ypos;
...
{
 int n;
 double ppst,Sres,varx,vary;//,zz,z1,z2;
 float stucon [34][2] =  {
	{ 1 , 12.706 } ,
	{ 2 ,  4.303 } ,
	{ 3 ,  3.182 } ,
